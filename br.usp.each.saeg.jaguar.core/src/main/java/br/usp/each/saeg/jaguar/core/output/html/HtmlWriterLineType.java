...
public class HtmlWriterLineType {
	...
	private static final String TEST_REQUIREMENT_TABLE_HTML_TEMPLATE_PATH = "br.usp.each.saeg.jaguar.core/src/main/resources/html-output/html/test-requiremente-table-template.html";
	...
	public HtmlWriterLineType(
		...
		this.requirementType = TestRequirementUtils.getType(testRequirementsList);
